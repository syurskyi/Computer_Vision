...
stochastic_gradient_descent = SGD(lr=0.01, nesterov=True, momentum=0.9, decay=0.01/40)
...
#saving the model
vggnet_model.save("vggnet_cifar10.hdf5")
print("saved the model as vggnet_cifar10.hdf5")
