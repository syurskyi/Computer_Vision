...
trained_model = mnist_model.fit(trainX, trainY, validation_data=(testX, testY), epochs=1, batch_size=128)
...
plt.figure()
plt.plot(np.arange(0,1), trained_model.history["loss"], label="train_loss")
plt.plot(np.arange(0,1), trained_model.history["val_loss"], label="val_loss")
plt.plot(np.arange(0,1), trained_model.history["accuracy"], label="train_acc")
plt.plot(np.arange(0,1), trained_model.history["val_accuracy"], label="val_acc")
