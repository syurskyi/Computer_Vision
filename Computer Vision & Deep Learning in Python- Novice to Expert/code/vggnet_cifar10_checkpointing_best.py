...
file_name = "vggnet_cifar10_best.hdf5"
#instantiate ModelCheckpoint class
improvement_checkpoint = ModelCheckpoint(file_name, monitor="val_accuracy", save_best_only=True, verbose=1)
...
history_trained_model = vggnet_model.fit(trainX, trainY, validation_data=(testX, testY), epochs=2, batch_size=64, callbacks=improvement_callback)
